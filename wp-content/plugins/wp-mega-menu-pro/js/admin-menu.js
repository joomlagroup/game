       ...
       $('#wpmm_menu_'+id+' #wpmm-popup-wrap-'+id+' .wpmm-add-group-btn').on('click', function() { 
        ...
        $('body').on('click', '.wpmm-group-remover', function () {
            ...
            if (new_groups != 1) {
                ...
                $('#wpmm_menu_'+id+' .wpmm-field-total-group').val(new_groups);
                $('#wpmm_menu_'+id+' .wpmm-group-trigger[data-group-ref="'+new_groups+'"]').addClass('wpmm-grp-active-trigger');
                $('#wpmm_menu_'+id+' .wpmm_widgets_setup[data-group-ref="'+new_groups+'"]').show();
             }
