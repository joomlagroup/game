                    ...
                    <tr>
                      ...
                      <tr>
                        <td class='apmega-name'>
                            ...
                            <p class='description'>
                                <?php _e("Important Note: Assign Sticky Opacity to 1 to show menu on page scroll also. 
                                Default value is set to 0 which means the menu will be hidden on page scroll.", APMM_PRO_TD); ?>
                            </p>
                        </td>
                         <td class='apmega-value'>
