...
$sql = "CREATE TABLE IF NOT EXISTS $table_name 
                                    ...
                                    -- custom_styling LONGTEXT,
                                    created datetime,
                                    modified datetime
                                    )";
$wpdb->query($sql);

$table_names = $wpdb->prefix . 'apmm_menugrouplists';
$sql2 = "CREATE TABLE IF NOT EXISTS $table_names 
                                    (
                                    id INT NOT NULL AUTO_INCREMENT, 
                                    PRIMARY KEY(id),
                                    menuid BIGINT,
                                    group_type VARCHAR(225),
                                    widget_details VARCHAR(225),
                                    totalgroup VARCHAR(225),
                                    group_details VARCHAR(225)
                                    )";
$wpdb->query($sql2);
...
$empty = $wpdb->get_results("SELECT * FROM $table_name");      
  if( empty($empty) ){
               ...
               $wpmm_widgets = array(
                   ...
                   $wpmm_bottom_section = array(
                    ...
                    $wpmm_flyout = array(
                     ...
                     $wpmm_mobile_settings = array(
                           'togglebar_enable_bgcolor' => '1',
                           'togglebar_background_from' => '#5ec073',
                           'togglebar_height' => '40px',
                           'resposive_breakpoint_width' => '910px',
                          // 'toggle_bar_content' => 'Menu',
                           'icon_color' => '#ffffff',
                           'text_color' => '#ffffff',
      ...
      $all_parameters = array(
                      'general'           => $wpmm_general,
                      'menu_bar'          => $wpmm_menu_bar,
                      'top_menu'          => $wpmm_top_menu,
                      'megamenu_bar'      => $wpmm_megamenu_bar,
                      'second_menu'       => $wpmm_second_menu,
                      'third_menu'        => $wpmm_third_menu,
                      'widgets'           => $wpmm_widgets,
                      'top_section'       => $wpmm_top_section,
                      'bottom_section'    => $wpmm_bottom_section,
                      'flyout'            => $wpmm_flyout,
                      'mobile_settings'   => $wpmm_mobile_settings,
                      'search_bar'        => $wpmm_search_bar
                      );
      ...
      $results = $wpdb->query( $insert_default );
  }
